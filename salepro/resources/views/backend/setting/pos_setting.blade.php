                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => 'setting.posStore', 'method' => 'post']) !!}
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <h4><strong>{{trans('file.Invoice Option')}}</strong></h4>
                                </div>
                                <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <h4><strong>{{trans('file.Thermal Invoice Size')}}</strong></h4>
                                </div>
                                <div class="col-md-12">
                                    ...
                                    @endif
                                    &nbsp;
                                    <label class="mt-2"><strong>{{trans('file.80mm')}}</strong></label>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    @endif
                                    &nbsp;
                                    <label class="mt-2"><strong>{{trans('file.58mm')}}</strong></label>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
