...
class ProductController extends Controller
{
    ...
    public function productData(Request $request)
    {
        ...
        else
        {
            ...
            $q = Product::select('products.*')
                ...
                ->join('product_purchases','product_purchases.product_id','=', 'products.id')
    ...
    public function printBarcode(Request $request)
    {
        ...
        return view('backend.product.print_barcode', compact('lims_product_list_without_variant', 'lims_product_list_with_variant', 'preLoadedproducts'));
    }
