                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <li><button type="button" data-id="{{$coupon->id}}" data-name="{{$coupon->name}}" data-code="{{$coupon->code}}" data-type="{{$coupon->type}}" data-amount="{{$coupon->amount}}" data-minimum_amount="{{$coupon->minimum_amount}}" data-quantity="{{$coupon->quantity}}" data-expired_date="{{$coupon->expired_date}}" class="edit-btn btn btn-link" data-toggle="modal" data-target="#editModal"><i class="dripicons-document-edit"></i> {{trans('file.edit')}}</button></li>
                ...
                {!! Form::open(['route' => 'coupon.store', 'method' => 'post']) !!}
                  <div class="row">
                    <div class="col-md-6 form-group">
                        <label>{{trans('file.Coupon Name')}} *</label>
...
<script type="text/javascript">
    ...
    $(document).on("click", '#create-modal .genbutton', function(){
      $.get('coupon/gencode', function(data){
    ...
    $(document).ready(function() {
        $(document).on('click', '.edit-btn', function() {
            ...
            // Select the option in the 'type' select element
            $("#editModal select[name='type'] option[value='" + type + "']").prop('selected', true);
        });
    });
