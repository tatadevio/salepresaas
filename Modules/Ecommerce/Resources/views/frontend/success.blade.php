...
@section('content')
    ...
    <section class="">
        <div class="col-md-6 offset-md-3 text-center mb-5">
            ...
            <p class="lead">{{trans('file.Here is your order reference no')}}- <span class="theme-color">{{$sale_reference}}</span>. {{trans('file.You will receive an email with delivery details shortly')}}
        </div>
    </section>
    <!--Section ends-->
@endsection
