...
@section('content')
    ...
    <div class="breadcrumb-section">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h1 class="page-title">{{trans('file.My Addresses')}}</h1>
                    <ul>
                        <li><a href="{{url('customer/profile')}}">{{trans('file.dashboard')}}</a></li>
                        <li class="active">{{trans('file.My Addresses')}}</li>
                    </ul>
                </div>
            </div>
        </div>
                                            ...
                                            <div class="col-md-12 mb-3">
                                                <div class="text-block row">
                                                    <div class="form-group col-md-6">
                                                        <input class="form-control" type="text" name="name" placeholder="{{trans('file.Name')}}">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <input class="form-control" type="text" name="phone" placeholder="{{trans('file.Phone')}}">
                                                    </div>
                                                    <div class="form-group col-md-12">
                                                        <input class="form-control" type="text" name="address" placeholder="{{trans('file.Address')}} *" required>
                                                    </div>
                                                    <div class="form-group col-md-3">
                                                        <input class="form-control" type="text" name="city" placeholder="{{trans('file.City')}} *" required>
                                                    </div>
                                                    <div class="form-group col-md-3">
                                                        <input class="form-control" type="text" name="state" placeholder="{{trans('file.State')}}">
                                                    </div>
                                                    <div class="form-group col-md-3">
                                                        <input class="form-control" type="text" name="country" placeholder="{{trans('file.Country')}} *" required>
                                                    </div>
                                                    <div class="form-group col-md-3">
                                                        <input class="form-control" type="text" name="zip" placeholder="{{trans('file.Zip / Postal code')}} *" required>
                                                    </div>
