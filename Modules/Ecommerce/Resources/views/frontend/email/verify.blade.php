							...
							<table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
								<tr>
									<td style="padding:0 0 36px 0;color:#153643;text-align:center">
										...
										<p>Thank you for signing up. Please click on the button below to verify your email</p><br><br>

										<p style="margin:0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;"><a style="color:#00a884;text-decoration:underline;" href="{{ url('/verify') }}/{{ $data['user_id'] }}">Verify Email</a></p><br>
