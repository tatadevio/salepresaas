...
<section>
    ...
    <div class="container-fluid">
        ...
        <div class="row" id="main-row">
            <div class="col-sm-4">
                <h4><span>{{trans('file.Available Widgets')}}</span></h4>
                <p>{{trans('file.To add a widget to a section, drag it onto that section')}}</p>
            ...
            <div class="col-sm-8">
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="mb-3">{{trans('file.Section Above Footer')}}</h4>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="mb-3">{{trans('file.Footer Section')}}</h4>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="mb-3">{{trans('file.Product Details Sidebar')}}</h4>
                                <div class="widgets widget-section">
