...
class PackingSlipController extends Controller
{
    ...
    public function store(Request $request)
    {
    	...
    	$sale = Sale::with('customer')->select('id', 'sale_status', 'customer_id', 'warehouse_id', 'shipping_name', 'shipping_address', 'shipping_city', 'shipping_country')->find($data['sale_id']);
        if($packing_slip)
