...
class BkashPayment implements PaybleContract
{
    ...
    public function __construct()
    {
        ...
        $this->app_key = $general_setting->bkash_app_key;
        $this->app_secret = $general_setting->bkash_app_secret;
        $this->username = $general_setting->bkash_username;
        $this->password = $general_setting->bkash_password;
